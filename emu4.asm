...
INITAB: JP      WARMST                        ; Warm start jump
        ...
        .db     0x035,0x04A,0x0CA,0x099       ;-2.65145E+07
        .db     0x039,0x01C,0x076,0x098       ; 1.61291E+07
        .db     0x022,0x095,0x0B3,0x098       ;-1.17691E+07
        .db     0x00A,0x0DD,0x047,0x098       ; 1.30983E+07
        .db     0x053,0x0D1,0x099,0x099       ;-2-01612E+07
        .db     0x00A,0x01A,0x09F,0x098       ;-1.04269E+07
        .db     0x065,0x0BC,0x0CD,0x098       ;-1.34831E+07
        .db     0x0D6,0x077,0x03E,0x098       ; 1.24825E+07
        .db     0x052,0x0C7,0x04F,0x080       ; Last random number
...
CHKSTK: PUSH    HL                            ; Save code string address
        ...
        ADD     HL,BC                         ; 2 Bytes for 0xeac level
        ADD     HL,BC
        .db     0x3E                          ; Skip "PUSH HL"
ENFMEM: PUSH    HL                            ; Save code string address
        LD      A,0x0D0                       ; LOW -48; 48 Bytes minimum RAM
        SUB     L
        LD      L,A
        LD      A,0x0FF                       ; HIGH (-48); 48 Bytes minimum RAM
        SBC     A,H
...
;
PUTBUF: CP      0x20                          ; Is it a control code?
...
LISTLP: POP     HL                            ; Restore address of line
        ...
        LD      A,0x20                        ; Space after line number
...
PRNTLP: RET     Z                             ; End of list - Exit
        ...
        LD      (HL),0x20                     ; Followed by a space
...
;
UNITY:  .db     0x000,0x000,0x000,0x081       ; 1.00000
;
LOGTAB: .db     3                             ; Table used by LOG
        .db     0x0AA,0x056,0x019,0x080       ; 0.59898
        .db     0x0F1,0x022,0x076,0x080       ; 0.96147
        .db     0x045,0x0AA,0x038,0x082       ; 2.88539
;
...
;
POWERS: .db     0x0A0,0x086,0x001             ; 100000
        .db     0x010,0x027,0x000             ; 10000
        .db     0x0E8,0x003,0x000             ; 1000
        .db     0x064,0x000,0x000             ; 100
        .db     0x00A,0x000,0x000             ; 10
        .db     0x001,0x000,0x000             ; 1
;
...
EXPTAB: .db     8                             ; Table used by EXP
        .db     0x040,0x02E,0x094,0x074       ; -1/7! (-1/5040)
        .db     0x070,0x04F,0x02E,0x077       ;  1/6! ( 1/720)
        .db     0x06E,0x002,0x088,0x07A       ; -1/5! (-1/120)
        .db     0x0E6,0x0A0,0x02A,0x07C       ;  1/4! ( 1/24)
        .db     0x050,0x0AA,0x0AA,0x07E       ; -1/3! (-1/6)
        .db     0x0FF,0x0FF,0x07F,0x07F       ;  1/2! ( 1/2)
        .db     0x000,0x000,0x080,0x081       ; -1/1! (-1/1)
        .db     0x000,0x000,0x000,0x081       ;  1/0! ( 1/1)
;
...
;
RNDTAB: .db     0x068,0x0B1,0x046,0x068       ; Table used by RND
        .db     0x099,0x0E9,0x092,0x069
        .db     0x010,0x0D1,0x075,0x068
;
...
;
HALFPI: .db     0x0D0b0,0x00F,0x049,0x081     ; 1.5708 (PI/2)
;
QUARTR: .db     0x000,0x000,0x000,0x07F       ; 0.25
;
SINTAB: .db     5                             ; Table used by SIN
        .db     0x0BA,0x0D7,0x01E,0x086       ; 39.711
        .db     0x064,0x026,0x099,0x087       ;-76.575
        .db     0x058,0x034,0x023,0x087       ; 81.602
        .db     0x0E0,0x05D,0x0A5,0x086       ;-41.342
        .db     0x0DA,0x00F,0x049,0x083       ; 6.2832
;
...
ATNTAB: .db     9                             ; Table used by ATN
        .db     0x04A,0x0D7,0x030b0,0x078     ; 1/17
        .db     0x002,0x06E,0x084,0x070b0     ;-1/15
        .db     0x0FE,0x0C1,0x02F,0x07C       ; 1/13
        .db     0x074,0x031,0x09A,0x07D       ;-1/11
        .db     0x084,0x03D,0x05A,0x07D       ; 1/9
        .db     0x0C8,0x07F,0x091,0x07E       ;-1/7
        .db     0x0E4,0x0B0b0,0x04C,0x07E     ; 1/5
        .db     0x06C,0x0AA,0x0AA,0x07F       ;-1/3
        .db     0x000,0x000,0x000,0x081       ; 1/1
;
...
;
MONOUT: JP      0x0008                        ; output a char
;
MONITR: JP      0x0000                        ; Restart (Normally Monitor Start)
;
