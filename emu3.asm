...
INIT:   LD      DE,INITAB       ; Initialise workspace
        LD      B,INITBE-INITAB+; Bytes to copy
...
INITAB: JP      WARMST          ; Warm start jump
        ...
        .db     0x035,0x04A,0CAH;-2.65145E+07
        .db     0x039,0x01C,076H; 1.61291E+07
        .db     0x022,0x095,0B3H;-1.17691E+07
        .db     0x00A,0x0DD,047H; 1.30983E+07
        .db     0x053,0x0D1,099H;-2-01612E+07
        .db     0x00A,0x01A,09FH;-1.04269E+07
        .db     0x065,0x0BC,0CDH;-1.34831E+07
        .db     0x0D6,0x077,03EH; 1.24825E+07
        .db     0x052,0x0C7,04FH; Last random number
...
;
UNITY:  .db     0x000,0x000,000H; 1.00000
;
LOGTAB: .db     3               ; Table used by LOG
        .db     0x0AA,0x056,019H; 0.59898
        .db     0x0F1,0x022,076H; 0.96147
        .db     0x045,0x0AA,038H; 2.88539
;
...
;
HALF:   .db     0x00,0x00,00H,80; 0.5
;
POWERS: .db     0x0A0,0x086,001H; 100000
        .db     0x010,0x027,000H; 10000
        .db     0x0E8,0x003,000H; 1000
        .db     0x064,0x000,000H; 100
        .db     0x00A,0x000,000H; 10
        .db     0x001,0x000,000H; 1
;
...
EXPTAB: .db     8               ; Table used by EXP
        .db     0x040,0x02E,094H; -1/7! (-1/5040)
        .db     0x070,0x04F,02EH;  1/6! ( 1/720)
        .db     0x06E,0x002,088H; -1/5! (-1/120)
        .db     0x0E6,0x0A0,02AH;  1/4! ( 1/24)
        .db     0x050,0x0AA,0AAH; -1/3! (-1/6)
        .db     0x0FF,0x0FF,07FH;  1/2! ( 1/2)
        .db     0x000,0x000,080H; -1/1! (-1/1)
        .db     0x000,0x000,000H;  1/0! ( 1/1)
;
...
;
RNDTAB: .db     0x068,0x0B1,046H; Table used by RND
        .db     0x099,0x0E9,092H,069H                              
        .db     0x010,0x0D1,075H,068H                              
;
...
;
HALFPI: .db     0x0DB,0x00F,049H; 1.5708 (PI/2)
;
QUARTR: .db     0x000,0x000,000H; 0.25
;
SINTAB: .db     5               ; Table used by SIN
        .db     0x0BA,0x0D7,01EH; 39.711
        .db     0x064,0x026,099H;-76.575
        .db     0x058,0x034,023H; 81.602
        .db     0x0E0,0x05D,0A5H;-41.342
        .db     0x0DA,0x00F,049H; 6.2832
;
...
ATNTAB: .db     9               ; Table used by ATN
        .db     0x04A,0x0D7,03BH; 1/17
        .db     0x002,0x06E,084H;-1/15
        .db     0x0FE,0x0C1,02FH; 1/13
        .db     0x074,0x031,09AH;-1/11
        .db     0x084,0x03D,05AH; 1/9
        .db     0x0C8,0x07F,091H;-1/7
        .db     0x0E4,0x0BB,04CH; 1/5
        .db     0x06C,0x0AA,0AAH;-1/3
        .db     0x000,0x000,000H; 1/1
;
